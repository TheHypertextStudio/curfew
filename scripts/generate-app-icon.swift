...
let variants: [Variant] = [
    Variant(
        name: "dawn",
        sky: [
            Stop(p: 0, c: (0.17, 0.16, 0.31)),
            Stop(p: 0.52, c: (0.17, 0.16, 0.31)),
    ...
    Variant(
        name: "day",
        sky: [
            Stop(p: 0, c: (0.24, 0.50, 0.74)),
            Stop(p: 0.55, c: (0.24, 0.50, 0.74)),
    ...
    Variant(
        name: "dusk",
        sky: [
            Stop(p: 0, c: (0.09, 0.10, 0.19)),
            Stop(p: 0.5, c: (0.09, 0.10, 0.19)),
    ...
    Variant(
        name: "night",
        sky: [
            Stop(p: 0, c: (0.05, 0.06, 0.13)),
            Stop(p: 0.62, c: (0.05, 0.06, 0.13)),
