        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            CurfewPanel {
                ...
                if snapshot.canRequestExtension {
                    ...
                    .simultaneousGesture(
                        LongPressGesture(minimumDuration: CurfewAppModel.extensionConfirmationHoldSeconds)
                            .onEnded { _ in
    ...
    var body: some View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                CurfewPanel {
                    CurfewSectionTitle(title: "Tomorrow", subtitle: snapshot.scheduleSummarySentence)
                    if let pending = snapshot.pendingScheduleDescription {
                        Text(pending)
                            .font(CurfewTypography.body(14))
                            .foregroundStyle(CurfewTheme.warning)
                ...
                CurfewPanel {
                    ...
                    if !model.settings.hasCompletedInitialSetup {
                        Text("Setup is not complete. Curfew stays disarmed until you complete setup.")
                            .font(CurfewTypography.body(14))
                            .foregroundStyle(CurfewTheme.mutedInk)
                        ...
                        Text("Debug launches are safe by default. Start enforcement manually when you want to test lock behavior.")
                            .font(CurfewTypography.body(14))
                            .foregroundStyle(CurfewTheme.mutedInk)
