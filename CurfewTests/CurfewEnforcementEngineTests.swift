...
struct CurfewEnforcementEngineTests {
    ...
    func workingStateBeforeWarning() throws {
        ...
        let date = try #require(calendar.date(from: .init(year: 2026, month: 2, day: 2, hour: 16, minute: 0)))
    ...
    func warningAtThirty() throws {
        ...
        let engine = CurfewEnforcementEngine(calendar: calendar)
        let date = try #require(calendar.date(from: .init(year: 2026, month: 2, day: 2, hour: 17, minute: 30)))
    ...
    func lockoutAtCurfew() throws {
        ...
        let engine = CurfewEnforcementEngine(calendar: calendar)
        let date = try #require(calendar.date(from: .init(year: 2026, month: 2, day: 2, hour: 18, minute: 0)))
    ...
    func dayOffState() throws {
        ...
        let engine = CurfewEnforcementEngine(calendar: calendar)
        let date = try #require(calendar.date(from: .init(year: 2026, month: 2, day: 1, hour: 18, minute: 0))) // Sunday
    ...
    func customWarningIntervals() throws {
        ...
        let date = try #require(calendar.date(from: .init(year: 2026, month: 2, day: 2, hour: 17, minute: 52)))
    ...
    @Test("Extension requests are available only in thirty and fifteen-minute stages with custom intervals")
    func extensionAvailabilityForCustomIntervals() throws {
        ...
        let date = try #require(calendar.date(from: .init(year: 2026, month: 2, day: 2, hour: 17, minute: 38)))
    ...
    func overnightWindowRemainsLockedAfterMidnight() throws {
        ...
        let engine = CurfewEnforcementEngine(calendar: calendar)
        let date = try #require(calendar.date(from: .init(year: 2026, month: 2, day: 3, hour: 1, minute: 0)))
    ...
    func subMinuteRemainingDoesNotLockEarly() throws {
        ...
        let engine = CurfewEnforcementEngine(calendar: calendar)
        let date = try #require(calendar.date(from: .init(year: 2026, month: 2, day: 2, hour: 17, minute: 59, second: 1)))
